...
PLATFORMS = {
    ...
    "Shoper": {
        "strong": [
            # Shoper SaaS 1.x (stary frontend)
            r"\bShop5\b",
            ...
            r"cdn\.shoper\.pl",
            r"sklep-shoper\.pl",
            # Shoper SaaS 2.0 (nowy frontend — inne sygnatury!)
            r"/environment/cache/images/",
            r"/userdata/public/storefront/",
            r"Shoper\s+S\.A\.",
            r"Polityce plik.w cookies Shoper",
            r"oprogramowania sklepu.*?Shoper",
            r"dostawc. oprogramowania.*?Shoper",
            r"storefrontImages_",
        ],
        "medium": [
            r"\bcookie_read\b",
            ...
            # Shoper 2.0 URL patterns
            r'"/pl/new"',
            r'"/pl/promotions"',
            r"turbo-cache-control",
            r"turbo-prefetch",
            r"view-transition.*same-origin",
        ],
        "weak": [
            r"\bShoper\b",
            r"\bAurora\b",
    ...
    "SkyShop": {
        "strong": [
            ...
            r"Sklep internetowy na oprogramowaniu Sky-shop\.pl",
            r"/sklep/userdata/",
            r"compare\.mysky-shop\.pl",
        ],
        "medium": [
            r"\bcc_cookie\b",
            r"\bco_accept\b",
    ...
    "PrestaShop": {
        "strong": [
            ...
            r"Dane osobowe s. przetwarzane przez PrestaShop",
        ],
        "medium": [
            r"\bprestashop\b",
            r"/modules/ps_[a-zA-Z0-9_-]+/",
            r"/themes/[a-zA-Z0-9_-]+/assets/",
            r"/img/p/[0-9]",
            r"/img/cms/",
            r"id_product=",
    ...
    "SOTE": {
        "strong": [
            ...
            r"st_get_component",
            r"stProduct",
            r"/core/apps/frontend/",
            r"oprogramowanie\s+SOTESHOP",
            r"sklep\s+internetowy\s+SOTESHOP",
        ],
        "medium": [
            r"sote-shop",
            r"soteshop\.com",
    ...
    "RedCart": {
        "strong": [
            ...
            r"redcart\.pl",
            r"rc[0-9]+\.redcart\.pl",
            r"Sklep internetowy na oprogramowaniu RedCart",
            r"oprogramowanie RedCart",
        ],
        "medium": [
            r"redcart_",
            r"RedCart",
    ...
    "ShopGold": {
        "strong": [
            r"shopgold\.pl",
            r"shopGold\.pl",
            r"oprogramowanie\s+sklepu\s+shopGold",
            r"Program shopGold",
            r"demo\.shopgold\.com\.pl",
            r"ustawienia-cookies\.html",
            r"shopgold\.com\.pl",
        ],
        "medium": [
            r"shopgold-",
    ...
    "Wix eCommerce": {
        ...
        "medium": [r"wixstatic\.com", r"wix\.com"],
        "weak": [],
    },
